...
def level_6_2(gameDisplay,screen_x,screen_y):
    fond=pygame.image.load('Level/level_6_2.png').convert()
    fond_width,fond_height = fond.get_rect().size
    
    #Limites
    #Limites
    mur0 = wall(0,0,1000,65,screen_x,screen_y)
    mur1 = wall(0,0,5,605,screen_x,screen_y)
    mur9 = wall(995,0,5,707,screen_x,screen_y)
    mur10 = wall(0,702,1000,5,screen_x,screen_y)   

    #Maisons
    mur2 = wall(0,0,302,315,screen_x,screen_y)
    mur3 = wall(485,2,512,483,screen_x,screen_y)
    
    #Arbre
    mur4 = wall(110,72,316,165,screen_x,screen_y)
    mur5 = wall(105,237,292,95,screen_x,screen_y)
    mur6 = wall(203,323,88,88,screen_x,screen_y)
    
    #pnj
    mur7 = wall(50,418,50,77,screen_x,screen_y)
    
    #truc rouge
    mur8 = wall(225,567,40,35,screen_x,screen_y)
...
def level_6_3_base(gameDisplay,screen_x,screen_y):
    fond=pygame.image.load('Level/level_6_3.png').convert()
    fond_width,fond_height = fond.get_rect().size
...
def level_6_3_sans(gameDisplay,screen_x,screen_y):
    fond=pygame.image.load('Level/level_6_3_sans_carton.png').convert()
    fond_width,fond_height = fond.get_rect().size
...
def level_6_3_avec(gameDisplay,screen_x,screen_y):
    fond=pygame.image.load('Level/level_6_3_carton.png').convert()
    fond_width,fond_height = fond.get_rect().size
    ...
    mur10 = wall(0,470,500,30,0,0)
    mur11 = wall(0,310,374,112,0,0)
    mur12 = wall(0,170,55,95,0,0)
    mur13 = wall(145,170,400,95,0,0)
    mur14 = wall(368,111,145,90,0,0)
...
def level_6_4_sans(gameDisplay,screen_x,screen_y):
    fond=pygame.image.load('Level/level_6_4_sans_planche.png').convert()
    fond_width,fond_height = fond.get_rect().size
...
def level_6_4_avec(gameDisplay,screen_x,screen_y):
    fond=pygame.image.load('Level/level_6_4_planche.png').convert()
    fond_width,fond_height = fond.get_rect().size
...
def level_6_5(gameDisplay,screen_x,screen_y):
    fond=pygame.image.load('Level/level_6_5.png').convert()
    fond_width,fond_height = fond.get_rect().size
